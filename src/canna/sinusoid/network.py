...
class SinusoidFlow(eqx.Module):
    """Velocity field over a set of sources conditioned on a time-frequency image."""
    ...
    def __init__(
        ...
        **kwargs,
        ...
        (_, x_dim), (height, width, y_dim) = x_shape, y_shape
    ...
    def __call__(
        ...
        c = net.c_embed(net.t_embed(t).astype(self.dtype))
