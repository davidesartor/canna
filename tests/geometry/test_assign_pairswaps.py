...
from canna.geometries import Euclidean, Set, Toroidal
...
def test_assign_by_pairswaps_never_costs_more_than_its_starting_point_on_toroidal(
    n_points,
):
    geom = Set(Toroidal(dim=2))
    for trial in range(5):
